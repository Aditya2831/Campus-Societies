...
import GeneralSocs from './GeneralSocs';
...
<h2 className="font-chakraPetch text-3xl text-center" style={{ color: '#e6f2ff' }}>
  "Connecting Campus Communities: Explore your College Societies"
    ...
    <GeneralSocs img="https://th.bing.com/th/id/OIG4.PUDHnwXx2jG_BQcYonMl?w=1024&h=1024&rs=1&pid=ImgDetMain" title="TECHNICAL SOCIETIES" description="Ignite Curiosity, Engineer Tomorrow: Where Innovation Meets Passion, Unleashing the Power of Technology and Creativity!"/>
